    ...
    <form action="" method="post">
        ...
        <table class="w-100">
            ...
            <tr class="m-0 p-0">
                ...
                <td class="m-0 p-0">
                    <input class="form-control-lg m-0 p-0 ps-3 border border-black" id="txt--Surname_User" name="txt--Surname_User" type="text" placeholder="Saisissez votre Prénom" style="font-size: 1.6rem;"
                        value=
                        "<?php
                            if(isset($users[0]['surname'])){
                                echo ucfirst(strtolower($users[0]['surname']));
                            }else{
                ...
                <td class="m-0 p-0">
                    <select class="form-control-lg m-0 p-0 ps-3 w-100 border border-black" id="list_User_Type" name="list_User_Type" style="font-size: 1.6rem;">
                        <?php
                            ...
                            //$valeurDefault = isset($_SESSION['criteriaUserType']) ? htmlspecialchars($_SESSION['criteriaUserType']) : '';
                            if (isset($users[0]['type'])){
                                $valeurDefault = $users[0]['type'];
            ...
            <tr class="m-0 p-0">
                ...
                <td class="m-0 p-0">
                    <button type="submit" class="btn btn-lg btn-success fs-4" id="bt__userEdit--update" name="bt__userEdit--update">Valider</button>
...
<!-- Ajoutez cet élément après votre liste déroulante -->
<script>
    ...
    document.getElementById('bt__userEdit--update').onclick = function() {
        var monInput = document.getElementById('txt--Name_User');
        if (monInput.value.trim() === '') {
            monInput.style.backgroundColor = 'lightblue';
        }
    };
</script>
