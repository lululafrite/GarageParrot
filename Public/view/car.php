<?php include_once('../controller/car.controller.php'); ?>

<section class="m-5 d-flex flex-wrap justify-content-around" id="carSection"></section>
...
<?php include_once('../module/searchCar.php'); ?>