                ...
                <td class="d-flex flex-column flex-sm-row m-0 p-0 pb-5">
                    ...
                    <div class="pe-2 pb-2 pb-sm-0">
                        ...
                        <button
                            ...
                            id="bt_carEdit_cancel"
                            name="bt_carEdit_cancel"
                            onclick="retour()"
                            style="width: 100px;"
                        >
                            Retour
                    ...
                    <div>
                        ...
                        <button
                            ...
                            id="bt_carEdit_delete"
                            name="bt_carEdit_delete"
            ...
            <tr class="m-0 p-0">
                ...
                <td class="m-0 p-0">
                    ...
                    <input
                        ...
                        value= "<?php echo $Cars[0]['motorization']; ?>"
                    >
