    ...
    <form action="" method="post" id="formCarEdit" enctype="multipart/form-data">
        ...
        <table class="w-100">
            ...
            <tr class="m-0 p-0">
                ...
                <td class="m-0 p-0">
                    <textarea class="form-control-lg m-0 p-0 ps-3 border border-black fs-4" id="txt_carEdit_description" name="txt_carEdit_description" rows="3" placeholder="Saisissez les options et une description" oninput="validateInput('txt_carEdit_description','','labelMessageDescription','Saisissez les options et une description.')"><?php echo $Cars[0]['description'];?></textarea>
                </td>
            </tr>
