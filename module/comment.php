                                ...
                                <form action="" method="post">
                                    <div class="card-header fs-4">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <input type="text" readonly value="<?php echo $Comment[$i]['pseudo']; ?>">
                                            <input type="text" style="text-align: center;" readonly value="Date : <?php echo $Comment[$i]['date_']; ?>">
                                            <input type="text" style="text-align: right;" readonly value=" note : <?php echo $Comment[$i]['rating']; ?>/5">
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <blockquote class="blockquote mb-0 fs-4">
                                            <textarea readonly rows="2"><?php echo $Comment[$i]['comment']; ?></textarea>
                                        </blockquote>
                                    </div>
                                    <?php
                                    ...
                                    ?>
                                        <div class="card-footer">
                                            <button class="btn btn-lg btn-primary" type="submit" id="bt_comment_delete" name="bt_comment_delete">Supprimer</button>
                                        </div>
                                    <?php
                                    }
                                    ?>
